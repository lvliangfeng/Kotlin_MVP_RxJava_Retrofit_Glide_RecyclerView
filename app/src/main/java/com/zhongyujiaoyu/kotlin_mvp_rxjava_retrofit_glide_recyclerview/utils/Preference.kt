...
class Preference<T>(val name: String, private val default: T) {
    companion object {
        ...
        private val prefs: SharedPreferences by lazy {
            ZYApplication.context.getSharedPreferences(file_name, Context.MODE_PRIVATE)
        }

        /**
         * 删除全部数据
         */
        fun clearPrefrence(): Unit {
    ...
    operator fun setValue(thisRef: Any?, priperty: KProperty<*>, value: T) {
